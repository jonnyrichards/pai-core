...
| Initiative | Start | Confidence | Effort | Drives | Deliverables | WorkItems | People |
|---|---|---|---|---|---|---|---|
| Customer Knowledge Base | Q3.0 | Committed | Large | Engagement | CKB in CZ | CKB in CZ: CZ admins can upload company context to Coach to make Coach's response more tailored and company-specific (EAP, GA → Q4) | Nate, Rachel, Lisa |
| Customer Knowledge Base | Q4.0 | High confidence | Medium | Engagement | CKB in EAP | CKB in EAP: Expand Customer Knowledge Base to EAP customers | Nate, Rachel, Lisa |
...
| Initiative | Start | Confidence | Effort | Drives | Deliverables | WorkItems | People |
|---|---|---|---|---|---|---|---|
| Coach Analytics | Q3.0 | High confidence | Medium | Foundation | Analytics dashboard | Analytics dashboard: Create an 'at a glance' view of popular Coach topics; enable inspection of de-identified traces | — |
...
| Initiative | Start | Confidence | Effort | Drives | Deliverables | WorkItems | People |
|---|---|---|---|---|---|---|---|
| Coach Voice | Q3.4 | Committed | Large | Engagement | Voice UX + latency optimisation | Voice UX + latency optimisation: Enable Voice for Engage / Perform, improve UX for high latency interactions | Nicha, Ally, Darsh |
